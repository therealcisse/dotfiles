...
local password = get_pass('cisse.amadou.9+mutt@gmail.com', 'imap.gmail.com')
local me = 'cisse.amadou.9@gmail.com'
...
function run()
  ...
  -- messages = inbox:contain_field('X-GitHub-Sender', 'amsayk')
